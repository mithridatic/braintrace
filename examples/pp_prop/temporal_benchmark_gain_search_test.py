"""Tests for the thin development gain-search CLI."""

from pathlib import Path

from temporal_benchmark_gain_search import _parser, _settings


def test_gain_cli_exposes_execution_not_scientific_knobs(tmp_path: Path) -> None:
    parser = _parser()
