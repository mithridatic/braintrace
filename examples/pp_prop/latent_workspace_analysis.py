...
def _selected_candidate_from_record(value: object, name: str) -> SelectedModelCandidate:
    ...
    decoded = DecodedCandidate(
        grid,
        changed_decision=cast(str | None, value["changed_decision"]),
        log_probability=cast(float, value["log_probability"]),
    )
    ...
    return SelectedModelCandidate(
        decoded,
        source_checkpoint=cast(int, value["source_checkpoint"]),
...
def _query_score_from_record(value: object, name: str) -> QueryScore:
    ...
    return QueryScore(
        ...
        query_index=cast(int, value["query_index"]),
        pass_at_1=cast(bool, value["pass_at_1"]),
        pass_at_2=cast(bool, value["pass_at_2"]),
        shape_accuracy=cast(bool, value["shape_accuracy_diagnostic"]),
        valid_cell_pixel_accuracy=cast(
            float, value["valid_cell_pixel_accuracy_diagnostic"]
        ),
