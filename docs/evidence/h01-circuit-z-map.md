...
| Synapse | Conductance and receiving voltage | Anatomically measured contact. Literature-pinned human PV-to-pyramidal receptor (3.1 nS, -75 mV, 4.18 ms) tested: +0.86 mV at the site, +0.008 mV at the soma (attenuation 110); the assumed 20 nS is a shunt. The deficit is the receptor site's electrotonic distance and its 7 mV offset below the soma, not the conductance | [pair result](h01-ie-pair-result.md), [literature](h01-ie-synapse-literature.json) |
