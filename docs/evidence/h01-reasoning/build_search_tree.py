...
def build_nodes():
    return [
        ...
        n("qc3_graph", O, "C3-A: partners exist. Prediction: every kept cell has a neuron partner in the 166-shard synapse export (NSI 300-2,300 per kept cell); at least 40 partners with >= 2 synapses to the kept set. Falsifier: fewer than 20 partners in total.",
          "Identity is the export's C3 neuron_id, the same segmentation as the skeletons; the proofread voxel-verification gate that excluded 120 of 123 edges does not apply. Result 2026-09-16 (h01-c3-candidates.json): 114,126 neuron-to-neuron rows over 166 shards; 85 partners of the kept 17 in total (falsifier not tripped), 4 with >= 2 synapses to the kept set (15 either direction); kept cell 5173982155 (C3 5421628756) has no partner; eligible E 72, I 12; candidates 20 E + 12 I.", [C3GRAPH, C3SPEC], "refuted"),
