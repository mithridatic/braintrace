...
def build_nodes():
    return [
        ...
        n("datum_rest", D, "Datum, rest: donor rest from donor-rest.json (L2 -84.26, L4 -81.01, PV -86.76, SST -77.15 mV); tolerance 3 sd of the donor's repeat level (0.04-0.15 mV measured) on the 100 ms before the pulse and the 10 ms ending 200 ms after it. Failure: any -20 mV crossing before the pulse.",
