...
Model: SP3 gain-split candidate s0-ksahp-b (docs/specs/2026-09-07-h01-e-gain-split.md). Contract column: the approved
...
| 200 pA | width_ms | 1 | 0.967 | 0.983 | 0.193 | 0.0118 | pass | pass | 20 percent of this human cycle's width; spread from human repeats |
| 200 pA | ahp_mv | 1 | -70 | -74.6 | 2 | 1.01 | unresolvable | fail | 2 mV of trough depth; spread from human repeats |
...
| Cycle | cycle_ms | ahp_mv | width_ms | peak_mv | threshold_mv |
| --- | --- | --- | --- | --- | --- |
| 1 | 226.01 | -74.56 | 0.983 | 37.12 | -57.21 |
