...
Model: SP3 gain-split candidate s0-ksahp-tail5 (docs/specs/2026-09-07-h01-e-gain-split.md). Contract column: the approved
...
| 200 pA | ahp_mv | 1 | -70 | -71 | 2 | 1.01 | unresolvable | fail | 2 mV of trough depth; spread from human repeats |
...
| Cycle | cycle_ms | ahp_mv | width_ms | peak_mv | threshold_mv |
| --- | --- | --- | --- | --- | --- |
| 1 | 130.60 | -71.01 | 0.987 | 37.16 | -57.21 |
