...
| E cell repair | Axonal initiation site plus somatic sodium 0.9, SK 0.5 and calcium decay 1.0: count 5 of 5 at 250 pA and 9 of 10 at 310 pA; threshold, peak, trough, width and adaptation inside the usable limits; rate at 310 pA misses by 0.1 Hz; cap of 8 spent | A finished E cell: one dose step and the sweep 55 prediction remain (returned) | [E result](h01-e-usable-result.md) |
