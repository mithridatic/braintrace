...
| E cell repair in progress | Axonal initiation site established; the Stage A2 survivor (somatic sodium 0.9) matches the human count at 250 pA with threshold, peak, trough and late cycles inside the usable limits; at 310 pA it fires 5 against 10 (late train at half rate), under Stage B | A finished E cell | [Stage A2](h01-e-usable/stage-a2-decision.json), [Stage B0](h01-e-usable/stage-b0-decision.json) |
...
| Pair behaviour | Delivery verified; with the human-sized receptor one I spike moves the receptor site 0.86 mV and the soma 0.008 mV (attenuation 110); the assumed 20 nS acts as a shunt | Functional inhibition of the E soma: not possible from this receptor site with a human conductance; the placement is the open question | [pair result](h01-ie-pair-result.md) |
