...
def K_IV(cell, c='r', ax=None, double_exp=True):
    ...
    df=pd.read_csv(r'D:\Endurance\Paper\Apr2021\Fig4\k_ggmax_act.csv')
    df2=pd.read_csv(r'D:\Endurance\Paper\Apr2021\Fig4\k_ggmax_inact.csv')
    ax[3].plot(df.loc[df.Species=='Human'].volt, df.loc[df.Species=='Human']['mean'], 'or',fillstyle='none')
    ax[3].plot(df.loc[df.Species=='Mouse'].volt, df.loc[df.Species=='Mouse']['mean'], 'xb')
    ax[3].plot(df2.loc[df2.Species=='Human'].volt, df2.loc[df2.Species=='Human']['mean'], 'or', fillstyle='none')
    ax[3].plot(df2.loc[df2.Species=='Mouse'].volt, df2.loc[df2.Species=='Mouse']['mean'], 'xb')
    ax[3].plot(volts, ggmax, c)
    ax[3].plot(volts, ggmax_inact, c)
    ax[3].set_xlabel('mV')
    ax[3].set_ylabel('G/Gmax')
    
    df=pd.read_csv(r'D:\Endurance\Paper\Apr2021\Fig4\k_tau_act.csv')
    ax[4].plot(df.loc[df.Species=='Human'].volt, df.loc[df.Species=='Human']['mean'], 'or', fillstyle='none')
    ax[4].plot(df.loc[df.Species=='Mouse'].volt, df.loc[df.Species=='Mouse']['mean'], 'xb')
    ...
    if double_exp:
        df=pd.read_csv(r'D:\Endurance\Paper\Apr2021\Fig4\k_tau_inact_fast.csv')
        df2=pd.read_csv(r'D:\Endurance\Paper\Apr2021\Fig4\k_tau_inact_slow.csv')
        ax[5].plot(df.loc[df.Species=='Human'].volt, df.loc[df.Species=='Human']['mean'], 'or', fillstyle='none')
        ax[5].plot(df.loc[df.Species=='Mouse'].volt, df.loc[df.Species=='Mouse']['mean'], 'xb')
        ax[6].plot(df2.loc[df2.Species=='Human'].volt, df2.loc[df2.Species=='Human']['mean'], 'or', fillstyle='none')
        ax[6].plot(df2.loc[df2.Species=='Mouse'].volt, df2.loc[df2.Species=='Mouse']['mean'], 'xb')
        ...
        df=pd.read_csv(r'D:\Endurance\Modeling\WilbersEtAl\Channel fitting\Experimental means\k_tau_inact.csv')
...
def Na_IV(cell, c='r', ax=None):
    ...
    df=pd.read_csv(r'D:\Endurance\Paper\Apr2021\Fig3\na_ggmax.csv')
    df2=pd.read_csv(r'D:\Endurance\Paper\Apr2021\Fig3\na_ggmax_inact.csv')
