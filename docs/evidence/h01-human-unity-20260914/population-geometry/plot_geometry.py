...
fig.suptitle('Human H01 source geometry through the production compartment mesh\nAll cells checked; direct projections use first, largest edge inventory, and last cell. Static geometry only.')
